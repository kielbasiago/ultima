...
export abstract class SnesSession {
    ...
    protected initializeListeners(resolve: (arg: any) => void, reject: (arg: any) => void): void {
        ...
        this._client.onclose = (event) => {
            ...
            this.addLogMessage("Disconnected from SNI/Qusb2Snes");
            this.status = "ERROR";
            reject(null);
        };
